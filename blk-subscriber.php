...
//                'message' => 'Document signed successfully! Redirecting to document upload...',
    ...
    private function generate_application_details_html($application, $documents, $consent_records) {
        ...
        <div class="venus-app-details">
            ...
            <div class="venus-details-section">
                ...
                <table class="form-table">
                    <tr>
                        <th>Status:</th>
                        <td><span class="status-badge status-<?php echo esc_attr($application['application_status']); ?>"><?php echo esc_html(ucwords(str_replace('_', ' ', $application['application_status']))); ?></span></td>
                    </tr>
                    <tr>
                        <th>Created:</th>
                    ...
                    <table class="widefat">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="status-badge status-<?php echo esc_attr($doc['verification_status']); ?>"><?php echo esc_html(ucwords($doc['verification_status'])); ?></span></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
        ...
        .status-documents_pending { background: #fd7e14; color: white; }
        .status-documents_uploaded { background: #6f42c1; color: white; }
